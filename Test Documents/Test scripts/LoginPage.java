...
public class LoginPage extends BaseTest {
    ...
    public void testSuccessfulLogin() throws InterruptedException {
    	...
    	webDriver.findElement(By.name("email")).sendKeys("bharath@gmail.com");
        Thread.sleep(2000);
        webDriver.findElement(By.name("password")).sendKeys("Bharath@19");
        Thread.sleep(2000);
    ...
    public void testInvalidLogin() throws InterruptedException {
        ...
        webDriver.findElement(By.name("email")).sendKeys("bharath@gmail.com");
        Thread.sleep(2000);
        webDriver.findElement(By.name("password")).sendKeys("81989180");
        Thread.sleep(2000);
        webDriver.findElement(By.cssSelector(".btn.btn-primary")).click();
        Thread.sleep(2000);
        String alertMessage = webDriver.switchTo().alert().getText();
