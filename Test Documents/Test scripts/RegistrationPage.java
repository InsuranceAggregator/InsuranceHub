...
public class RegistrationPage extends BaseTest{
    ...
    public void testSuccessfulRegistration() throws InterruptedException {
    	webDriver.findElement(By.xpath("/html/body/app-root/app-login/body/div/div/p/a")).click();
    	webDriver.findElement(By.id("name")).sendKeys("Bharath");
        Thread.sleep(2000);
        webDriver.findElement(By.id("mobilenumber")).sendKeys("9998988799");
        Thread.sleep(2000);
        webDriver.findElement(By.id("email")).sendKeys("bharath@gmail.com");
        Thread.sleep(2000);
        webDriver.findElement(By.id("password")).sendKeys("Bharath@19");
        Thread.sleep(2000);
        webDriver.findElement(By.id("confirmpassword")).sendKeys("Bharath@19");
        Thread.sleep(2000);
    ...
    public void testInvalidRegistration() throws InterruptedException {
        ...
        Thread.sleep(2000);
        webDriver.findElement(By.id("mobilenumber")).sendKeys("98656263581");
        Thread.sleep(2000);
    ...
    public void testNoEntryRegistration() throws InterruptedException {
        ...
        Thread.sleep(2000);
        webDriver.findElement(By.id("mobilenumber")).sendKeys("");
        Thread.sleep(2000);
