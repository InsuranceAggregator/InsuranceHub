...
public class HomePage extends BaseTest{
    ...
    public void testSuccessfulLogin() throws InterruptedException {
        ...
        public void testPoliciesTab() throws InterruptedException {
            ...
            PoliciesTab.click();
            Thread.sleep(2000);
            WebElement HealthInsurance= webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[1]/div/div[1]/a"));
            Assert.assertTrue(HealthInsurance.isDisplayed());
            WebElement LifeInsurance= webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[1]/div/div[2]/a"));
            Assert.assertTrue(LifeInsurance.isDisplayed());
            WebElement VehicleInsurance= webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[1]/div/div[3]/a"));
            Assert.assertTrue(VehicleInsurance.isDisplayed());
            WebElement HomeInsurance= webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[1]/div/div[4]/a"));
        ...
        public void testClaimsTab() throws InterruptedException {
            WebElement claimsTab = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[3]/button"));
            claimsTab.click();
            Thread.sleep(2000);
            WebElement FindaNewClaim = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[3]/div/a[1]"));
            Assert.assertTrue(FindaNewClaim.isDisplayed());
            WebElement ExistingFiledClaim = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[3]/div/a[2]"));
            Assert.assertTrue(ExistingFiledClaim.isDisplayed());
            WebElement TrackTheFiledClaim = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[3]/div/a[3]"));
            Assert.assertTrue(TrackTheFiledClaim.isDisplayed());
        }
     
        /*@Test(priority = 5)
        public void testSupportTab() throws InterruptedException {
            WebElement supportTab = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[4]/button"));
            supportTab.click();
            Thread.sleep(2000);
            WebElement RaiseAnIssue = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[4]/div/a[1]"));
            Assert.assertTrue(RaiseAnIssue.isDisplayed());
            WebElement ContactUs = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[4]/div/a[2]"));
            Assert.assertTrue(ContactUs.isDisplayed());
            WebElement ChatWithUs = webDriver.findElement(By.xpath("/html/body/app-root/app-homepage/div/div/div[3]/div[4]/div/a[3]]"));
            Assert.assertTrue(ChatWithUs.isDisplayed());
        ...
        public void testWelcomeMessage() {
            ...
            Assert.assertTrue(welcomeMessage2.isDisplayed(), "Secure the Future, Protect Whats Important");
        }
      @Test(priority = 7)
